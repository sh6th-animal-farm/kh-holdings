...
public class TradingSimulationBot {
    ...
    public void runSimulation() {
        ...
        try {
            ...
            log.info(">>>> [BOT] 주문 생성 - ID: {}, 타입: {}, 사이드: {}, 가격: {}, 수량: {}",
                    randomOrder.getOrderId(), randomOrder.getOrderType(), randomOrder.getOrderSide(),
                    randomOrder.getOrderPrice(), randomOrder.getOrderVolume());
